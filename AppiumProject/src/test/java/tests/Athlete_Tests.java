...
import pages.Athlete_SignUp;

public class Athlete_Tests extends BaseClass {
	...
	public void firsttestcase() throws InterruptedException
	{
		...
		Thread.sleep(5000);
		createaccount.getemailfield().sendKeys("hamza+129@geeksofkolachi.com");
      ...
      //Clicking on create account button under "Confirm Account" screen	
		...
		Athlete_SignUp signup = new Athlete_SignUp(driver);
...
*/		
	...
	public void fifthtestcase() throws InterruptedException
	{
		...
		Thread.sleep(2000);
		String  expected_result4= "03/30/10";
